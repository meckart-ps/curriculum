...
console.log(calculateTotalCost(100, 0.07, 10)); // Output: 96.3
```
...
This technique should look familiar, aas we used it in the previous activity to create a random number for the guessing game.
