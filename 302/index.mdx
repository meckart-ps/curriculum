...
- **Time:** 1.5 hours
- **Terminus CLI Practice:** Continue working with the Terminus game for command line skills.
- **GitHub Reflection:** Review documentation and reflect on GitHub workflows.

#### Lesson 5: Scenario: Collaborating and Pull Requests
...
- **Activities:** Lab: Resolve pull requests and conflicts on GitHub
