...
You are working as part of a development team responsible for building an e-commerce website. Each team member is working on different features, but the team needs a system in place to review and approve changes before they are merged into the main branch of the project. To ensure code quality and streamline collaboration, the team uses **pull requests (PRs)** on GitHub. As part of this process, you will create a PR for the feature you developed, review a teammate's PR, and resolve any conflicts or issues that arise during the review process.

In this lesson, you will learn how to create pull requests, review them, and collaborate effectively using GitHub’s pull request system.
