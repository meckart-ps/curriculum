...
- **Activities:**
  - Hands-on coding exercises with variables, functions, and template literals.
  - Practice using Math methods for random number generation and calculations.
- **Knowledge Check:** Multiple-choice questions on variables, functions, and template literals.
...
- **Activities:**
  - Hands-on activity: Build a simple game using conditionals and objects.
...
- **Activity:** Build an interactive JavaScript-based app that incorporates DOM manipulation, arrays, objects, conditionals, and local storage. For example, a simplified e-commerce site where users can add items to a shopping cart, persist their cart data using local storage, and manage tasks dynamically.
...
- **Rubric:**
  - **Functionality**: (40%) - Does the application meet the functional requirements (e.g., DOM manipulation, array methods, object handling)?
  - **Code Quality**: (30%) - Is the code clean, well-organized, and commented appropriately?
  - **Efficiency**: (20%) - Is the application optimized for performance and minimal redundancy?
  - **Presentation**: (10%) - Is the project presented clearly, with proper UI and user interactions?
