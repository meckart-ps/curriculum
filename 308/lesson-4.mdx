...
Head over to [ALAB 308H.4.1 - JavaScript Conditionals, Loops, Objects, and Arrays](lab) and follow the instructions listed there to complete some coding challenges that cover the topics we've gone over thus far.
...
After completing the coding challenges above, complete [R-ALAB 308H.4.2 - Arrays, Loops, and Conditionals](lab-2), which will test your skills with some problem-solving scenarios.
